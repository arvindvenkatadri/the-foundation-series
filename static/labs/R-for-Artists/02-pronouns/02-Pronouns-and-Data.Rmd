...
+-----------+-----------+--------------+-----------+---------------------+
| Pronoun   | Answer    | Variable /   | Example   | What Operations?    |
|           |           | Scale        |           |                     |
+===========+===========+==============+===========+=====================+
| What,     | Name,     | Qualitative  | Name      | -   Count no. of    |
| Who,      | Place,    | /            |           |     cases           |
| Where,    | Animal,   | **Nominal**  |           |                     |
| Whom,     | Thing     |              |           | -   Mode            |
| Which     |           |              |           |                     |
+-----------+-----------+--------------+-----------+---------------------+
| How, What | A Manner  | Qualitative  | -   Socio | -   Median          |
| Kind,     | / Method, | /            | -economic | -   Percentiles     |
| What Sort | Type or   | **Ordinal**  |           |                     |
|           | Attribute |              |    status |                     |
|           | from a    |              |     ("low |                     |
|           | list,     |              |           |                     |
|           | with list |              |   income, |                     |
...
|           |           |              |   like"). |                     |
+-----------+-----------+--------------+-----------+---------------------+
| How Many  | Q         | Quantitative | -   pH    | -   Mean            |
| / Much /  | uantities | /            | -   SAT   |                     |
| Heavy?    | with      | **Interval** |     score | -   Standard        |
| Few?      | Scale.    |              |           |     Deviation       |
| Seldom?   |           |              | (200-800) |                     |
| Often?    | **Diff    |              | -         |                     |
| When?     | erences** |              |    Credit |                     |
...
|           |           |              |   College |                     |
+-----------+-----------+--------------+-----------+---------------------+
| How Many  | Qu        | Quantitative | -         | -   Correlation     |
| / Much /  | antities, | / **Ratio**  |   Weight, | -   Coeff of        |
| Heavy?    | with      |              |           |     Variation       |
| Few?      | Scale and |              |           |                     |
