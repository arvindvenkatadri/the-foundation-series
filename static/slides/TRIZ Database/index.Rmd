...
- One Good way to do this is using the **Ishikawa Diagram**
  ...
  - Man, Material, Method, "Manifestation" (Ishikawa)
...
- **TC**: 
    - I can either boil Milk, OR do something else, NOT both. Umm... 
    - Milk must not boil over EVEN if the Stove is on
]
.pull-right[
![](images/IshikawaDiagram2-386e9108096f4149b67cb5a803c45dd0.webp)
...
## TRIZ Workflow: Metaphorise the CONTRADICTION
...
Now to see how we can use each of these "metaphoric" solutions in our specific problem with Milk !!
...
.pull-right[
And of course, there is a patent.
...
- **Apply butter to the rim of the vessel beforehand !!** This is also a solution derivable from **IP-9: Prior CounterAction**
