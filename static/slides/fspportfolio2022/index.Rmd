...
- "Generalized" Problm Solving in TRIZ

### Dispositions:
- Metaphors as a gateway to Problem Solving
- Problems as Contradictions (Administrative, Technical, and Physical Contradictions in TRIZ)
- Resource Mentality: Titanic Game / Candle Game
- Six Hats Method of de Bono
- Ideal Final Result in TRIZ

### Skills:
- Ishikawa Diagram, Entities, and their Parameters
- Contradiction Matrix
- 39 TRIZ Metaphors
- 40 TRIZ Inventive Principles
- 6 TRIZ Separation Principles
]]
...
### *Segmentation*, 
### *Merging*, 
### *Phase Transitions*, *Self Service*
]
]
...
### *Composite Materials*, 
### *Local Quality*, 
### *Equipotentiality, Preliminary Anti-Action*
]
]
...
### Dispositions:
- Rewards, Risks, Regrets, and Retributions in Game Theory
- Bias
- Proximity in Space and in Data
- Randomness, Probability and Belief
- Predictions and Inference

### Skills:
- Voronoi/Delaunay Models in Geogebra
- Hypothesis Testing (Short Term Memory: Factors, Effect Sizes, p-values)
- Permutation Tests in Excel
- Machine Learning with zero-coding
  1. Classification (Random Forests)
  2. Linear Regression
]]
