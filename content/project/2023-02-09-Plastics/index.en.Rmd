...
Arabia](https://arvindvenkatadri.com/project/2022-12-20-triz-lawrence-of-arabia/)
and
[Spotify](https://arvindvenkatadri.com/project/2023-01-09-triz-spotify/).
...
over the past 8 years or more at the [Srishti Manipal Institute of Art,
Design, and Technology, Bangalore
INDIA.](https://srishtimanipalinstitute.in)

# Rivers of Plastic

According to [Our World in
Data](https://ourworldindata.org/ocean-plastics):
...
> thought, we will need *global efforts* to improve waste management and
> plastic collection rather than targeting only a few of the largest
> rivers.
>
...
-   First, using the method described in [*Open Source
    TRIZ*](https://www.youtube.com/watch?v=cah0OhCH55k), we identify
    *knobs* or *parameters* within the situation
...
Diagram](https://www.youtube.com/watch?v=cah0OhCH55k), we try to improve
a certain Parameter or we try to reduce its effect. In doing so we could
construct several alternative **Problem Descriptions**. ( Of course not
all Parameters may be accessible in a given situation )
...
-   Clearly we want the rivers to flow and give us our sense of [beauty,
    serenity and movement, and
    poetry](https://etc.usf.edu/lit2go/105/the-wind-in-the-willows/1795/the-open-road/),
...
-   So a simple dam or [weir-like](https://en.wikipedia.org/wiki/Weir)
...
-   Finally, we are interested in preserving dissolved oxygen in the
    ...
    Oxygen
    Demand](https://www.usgs.gov/special-topics/water-science-school/science/biological-oxygen-demand-bod-and-water).
...
`volume` of the **stationary** **plastic**, while not worsening the
`harmful effects` acting on the **river**. Note how the IFR is included
here, in using the word **stationary** for the object: the plastic must
**not** flow, while the river **must**.

As stated in my previous articles ( [Lawrence of
Arabia](https://arvindvenkatadri.com/project/2022-12-20-triz-lawrence-of-arabia/)
and
[Spotif](https://arvindvenkatadri.com/project/2023-01-09-triz-spotify/)y
...
Parameters**. Parameters chosen from the TRIZ Matrix can be thought of
as *metaphors* for the knobs that lie within our AC; Going from the AC
to the TC is an act of *making metaphors*. We could easily have chosen
the Parameter `Amount of Substance (10)` i.e. the plastic on the river,
as the "metaphoric thing" to improve but the current IFR speaks of the
...
manner. TRIZ tends to [focus our attention](v) like no other method that
I know of.
...
So there you have it! It seems that Going Dutch, even with bubbles, is a
good idea !
...
for example that lies at the root of our *Technical Contradiction*. We
need the River to flow all the time, but do we want flow *everywhere, at
all locations on the river?* This is a sort of Physical Contradiction,
and our solutions such as **(39)Inert Atmosphere** and
**24(Intermediary)** seem to suggest that we can partition our
river-flow in **physical Space.**

TRIZ offers us a smaller and more easily "memorizable" set of metaphoric
solutions in the form of **Separation Principles**. Here they are:
...
Our IFR states that we want the Plastics to be in the River and not in
the River at the same time. Can we make the River "less of a River" in
places? Can we make **separate** zones in the River don't flow and allow
us to harvest the plastic? So we are applying SEPARATION in SPACE here.
