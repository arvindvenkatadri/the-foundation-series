...
This piece stems from my teaching a course on Creative Thinking and Problem Solving based on TRIZ, titled *Play and Invent*, over the past 8 years or more at the <u>[*Srishti Manipal Institute of Art, Design, and Technology, Bangalore, India*](https://srishtimanipalinstitute.in)</u> . 



## Lawrence of Arabia: a Summary

The movie is the story of T.E. Lawrence, the English officer who successfully united and led the diverse, often warring, Arab tribes during World War I in order to fight the Turks. The stellar cast includes Peter O'Toole as Lawrence, Omar Sharif as Ali, Alec Guinness as Prince Feisal, Anthony Quinn as Auda Abu Tayi, Claude Raines as Dryden, and Anthony Quayle as Col. Brighton. The director was David Lean. The editing of the film by <u>[Anne Coates](<https://womenfilmeditors.princeton.edu/tag/lawrence-of-arabia/>)</u> is also much admired. 
...
`r blogdown::shortcode("youtube", "wyoEwfaXHkI")`
...
In the early morning, seemingly in a <u>[eureka moment](https://en.wikipedia.org/wiki/Eureka_effect)</u>, he decides that attacking Aqaba from the landward side would be a good solution, since the guns there could not be turned around. 


Here is Lawrence trying to convince Ali about this plan:

`r blogdown::shortcode("youtube", "5ZQSpMiaaxk")`


Lawrence does not inform Brighton of his plans, nor even Feisal. It is Ali who informs Feisal of this enterprise. Clearly, Lawrence does not consider Brighton as a member of his *Field* (as defined by Csikszentmihalyi in his <u>[Creativity Systems Model](<https://medium.com/call4/domain-8a22b6b486f4>)</u>, but Feisal is a Field Member to Ali. Apropos, the act of sitting up all night can be seen as the Incubation and Elaboration stages of the <u>[5 Stages of Creativity](https://pearce.caah.clemson.edu/the-5-step-creative-process/)</u> from Csikszentmihalyi (Preparation, Incubation, Insight, Elaboration, Execution).
...
First, using the method described in *Open Source TRIZ*, <u><https://www.youtube.com/watch?v=cah0OhCH55k></u>, we identify *knobs* or *parameters* within the situation and see how turning these could lead to identifying a Cause for a Problem in the form of a **Contradiction**. 
...
#Fishbone Diagram
#
ss.ceDiag(effect,causes.head,causes, main ="The Taking of Aqaba",
          #ss.col = c("", "#EECCDD"), 
...
Let us take the AC and convert it into a *Technical Contradiction(TC)*. We will look at the *48 TRIZ Parameters* in the <u>[*TRIZ Contradiction Matrix* **(PDF)**](/pdf/TRIZ/ContradictionMatrix2003.pdf)</u> and see which Parameter we want to improve, while not worsening another. Here is what we can attempt, stating the Contradiction both ways[^2]:
...
`r blogdown::shortcode("youtube", "lChJz2DSpsE")`
...
1. Lawrence of Arabia at the Internet Movie Data Base <u><https://www.imdb.com/title/tt0056172/></u>
...
1. Valery Souchkov, Defining Contradictions. <u><http://www.xtriz.com/Training/TRIZ_DefineContradiction_Tutorial.pdf></u>
