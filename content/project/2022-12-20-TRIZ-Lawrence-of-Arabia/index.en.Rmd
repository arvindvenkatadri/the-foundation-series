...
summary: 'The Attack on Aqaba: A TRIZ Analysis'
authors: []
external_link: ''
image:
...
<center><iframe width="560" height="315" src="https://www.youtube.com/embed/K34S8q76gDo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
...
In the early morning, seemingly in a [eureka moment](https://en.wikipedia.org/wiki/Eureka_effect), he decides that attacking Aqaba from the landward side would be a good solution, since the guns there could not be turned around. 


Here is Lawrence trying to convince Ali about this plan:

<center><iframe width="560" height="315" src="https://www.youtube.com/embed/5ZQSpMiaaxk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>

Lawrence does not inform Brighton of his plans, nor even Feisal. It is Ali who informs Feisal of this enterprise. Clearly, Lawrence does not consider Brighton as a member of his *Field* (as defined by Csikszentmihalyi in his [Creativity Systems Model](<https://medium.com/call4/domain-8a22b6b486f4>)), but Feisal is a Field Member to Ali. 

Apropos, the act of sitting up all night can be seen as the Incubation and Elaboration stages of the [5 Stages of Creativity](https://pearce.caah.clemson.edu/the-5-step-creative-process/) from Csikszentmihalyi (Preparation, Incubation, Insight, Elaboration, Execution).
...
Turning the *knobs/parameters* in the Ishikawa Diagram, it seems that if the British allies attack Aqaba, they may win, BUT they will lose a few warships. If the Arabs want to attack, they are too small in mumber and have no warships, and hence their chances of success are very slim. Herein lies the Contradiction, which we can now specify as an [**Administrative Contradiction(AC)**](https://altshuller.ru/world/eng/triz6.asp) in *plain English*: 

> <center>**AC**: The Arabs need the British to supply them via Aqaba port. Aqaba has huge guns and they will sink the British ships in that narrow gulf if they try a naval attack. So the Arabs need to take Aqaba without losing British ships.</center>
...
> <center> **IFR**: The Arabs need to attack and take Aqaba port, and the big guns there should have no effect.</center>

Note how the tone of this IFR is like a "eat my cake and have it too". Very typical for IFRs, this impossible-sounding tone!

Let us take the AC and convert it into a *Technical Contradiction(TC)*. We will look at the **48 TRIZ Parameters** in the [**Contradiction Matrix (PDF)**](/pdf/TRIZ/ContradictionMatrix2003.pdf) and see which Parameter we want to improve, while not worsening another. Here is what we can attempt, stating the Contradiction both ways[^2]:
...
Here we choose these Parameters based on our IFR that the guns at Aqaba should not affect the Arab attack at all. 

We could even stretch to making a *Physical Contradiction(PC)* happen:
  
> <center>**PC**: The Ships must be near the guns but not be near enough to be shot at. (They must be near and not near at the same time)</center>

## Solving the Technical Contradiction

Let us take the TC into the Contradiction Matrix and arrive at the TRIZ Inventive Principles. Here they are from the figure below:
...
How are we to apply these Inventive Principles?  
  ...
  - **IP 35: Parameter Change**. But "ships" on land??  Note, *the desert is an ocean into which no oar is dipped*. Sand and Water are both **Resources** in the problem.  So a different kind of ocean and therefore a different kind of ship. At a stretch, we can say the warships of the British Navy are being substituted with the use of ....Camels!! And, metaphorically speaking, it is *still* an attack using ships....*The Ships of the Desert*!! Parameter Change. 
  ...
  - **IP 40: Composite Materials**. What object within the situation can we reconstitute with smaller pieces of different types? The British Army...so more than one army? Yes! The Tribes need to unite into one *composite* army.  
...
<center><iframe width="560" height="315" src="https://www.youtube.com/embed/lChJz2DSpsE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>

I hope that was a much fun to read as it was for me to write it up !! 

## References

1. Lawrence of Arabia at the Internet Movie Data Base <https://www.imdb.com/title/tt0056172/>
1. Mihaly Csikszentmihalyi, Creativity, Flow, and the Psychology of Discovery and Invention. Harper Perennial; Reprint edition (August 6, 2013)
1. Jack Hipple, The Ideal Result and How to Achieve It. Springer; 2012th edition (June 26, 2012)
1. Valery Souchkov, Defining Contradictions. <http://www.xtriz.com/Training/TRIZ_DefineContradiction_Tutorial.pdf>




[^1]: I was not able to ascertain who is the author of this map. I would be happy to write to obtain permission and use it with acknowledgement. 

[^2]: The Contradiction Matrix is by and large symmetric, but there are a few places where it is not, so stating the Contradiction both ways allows us to access a slightly larger set of Inventive Principles from two cells of the Matrix.
