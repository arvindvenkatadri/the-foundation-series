...
1. What diagrams or thought experiments can we conduct to do this?
...
Who is our friend? What is the chance that we will survive? Who killed Dad?
...
### Data Analysis-1: Comparison of Histograms using Excel and WTFcsv

Let us collate all the data for all tests using Excel.
...
1. **Duplicate this data** on the sheet titled "Data Duplicated". **Do not touch** again the "RawData" sheet. 
