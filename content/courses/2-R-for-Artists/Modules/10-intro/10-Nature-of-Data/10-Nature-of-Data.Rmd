...
subtitle: "Understanding Human Experience, Experiments, and Data"
author: "Arvind V."
date: "`r Sys.Date()`"
output:
...
## Is This a Surprise?
.pull-left[Spotted in a men's washroom at BLR Airport - a diaper change station. <br><br>Childcare is not just a woman's responsibility. <br><br>👏🏻✨ ]
...
```{r, echo=FALSE, fig.width="480px", fig.align='center'}
ggplot(Night, aes(x = factor(Date), y = Deaths, fill = Cause)) +
    ...
    xlab("") + facet_grid(~ Regime) + theme_minimal() +
