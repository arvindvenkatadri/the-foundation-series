...
+----------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------------------------+------------------------+
| How Many / Much / Heavy? Few? Seldom? Often? When? | Quantities, with Scale and a Zero Value.                                                                                      | Quanitative / Ratio\*\*     | -   Weight,length,Height                                                                        | -   Correlation        |
|                                                    |                                                                                                                               |                             |                                                                                                 | -   Coeff of Variation |
...
| Aesthetic #1                | Aesthetic #2                     | Chart Picture                                                                                                                                      |
|-----------------------------|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| Position X = Quant Variable | Position Y = Quant Variable      | <img src="https://img.icons8.com/ios-filled/100/000000/scatter-plot.png"/>                                                                         |
| Position X = Qual Variable  | Shape = Count of Qual var)       | <img src="https://img.icons8.com/material/100/000000/futures--v1.png"/>                                                                            |
| Position X = Qual Variable  | Position Y = Qual Variable       | <img src="https://img.icons8.com/windows/100/000000/modern-art.png"/>                                                                              |
| Qualitative Variable        | Rank Ordered Quant Variable      | <img src="https://img.icons8.com/external-icongeek26-glyph-icongeek26/100/000000/external-plot-data-analytics-icongeek26-glyph-icongeek26-1.png"/> |
| Quant Variable              | Quant Variable + Qual Var        | <img src="https://img.icons8.com/ios-filled/100/000000/area-chart.png"/>                                                                           |
| Quant Variable              | Shape = Line with Quant Variable | <img src="https://img.icons8.com/material/24/000000/combo-chart--v1.png"/>                                                                         |
