...
+==============================+===========================+
| To be, or not to be: that is | The first six words of    |
| the question:                | the soliloquy establish a |
|                              | balance. There is a       |
|                              | direct opposition – to    |
|                              | be, or not to be. Hamlet  |
|                              | is thinking about life    |
|                              | and death and pondering a |
|                              | state of being versus a   |
|                              | state of not being –      |
|                              | being alive and being     |
|                              | dead.                     |
+------------------------------+---------------------------+
| Whether ’tis nobler in the   | The balance continues     |
| mind to suffer\              | with a consideration of   |
| *The slings and arrows of    | the way one deals with    |
| outrageous fortune*,\        | life and death. Life is a |
| Or to take arms against a    | lack of power: the living |
| *sea of troubles*,\          | are at the mercy of *the  |
| And by opposing end them?    | blows of outrageous       |
|                              | fortune*.                 |
+------------------------------+---------------------------+
| To die: to sleep;\           | The balance continues     |
| No more; and by a sleep to   | with a consideration of   |
| say we end\                  | the way one deals with    |
| The heart-ache and the       | life and death. Life is a |
| *thousand natural shocks*\   | lack of power: the living |
| That flesh is heir to, ’tis  | are at the mercy of the   |
| a consummation\              | blows of outrageous       |
| Devoutly to be wish’d.       | fortune. The only action  |
|                              | one can take against the  |
|                              | things he lists among     |
|                              | those blows is to end     |
|                              | one’s life.               |
|                              |                           |
|                              | That’s the only way of    |
|                              | opposing them. The ‘sleep |
|                              | of death’ is therefore    |
|                              | empowering: killing       |
|                              | oneself is a way of       |
|                              | taking action, taking up  |
|                              | arms, opposing and        |
|                              | defeating the slings and  |
|                              | arrows of outrageous      |
|                              | fortune. Living is a      |
|                              | passive state; dying is   |
|                              | an active state.          |
+------------------------------+---------------------------+
| To die, to sleep;\           | Death is something        |
| To sleep: perchance to       | desirable – devoutly to   |
| dream: ay, there’s the rub;\ | be wished, a consummation |
| For in that sleep of death   | – a perfect closure. It’s |
| what dreams may come\        | nothing more than a       |
| When we have shuffled off    | sleep.                    |
| this mortal coil,\           |                           |
| Must give us pause: there’s  | But there’s a catch,      |
| the respect\                 | which Hamlet calls a rub. |
| That makes calamity of so    | A ‘rub’ is a bowls term   |
| long life;\                  | meaning an obstacle on    |
| For who would bear the       | the bowls lawn that       |
| *whips and scorns of time*,\ | diverts the bowl, so the  |
| The oppressor’s wrong, the   | fear of the life          |
| proud man’s contumely,\      | hereafter is the obstacle |
| The pangs of despised love,  | that makes us pause and   |
| the law’s delay,\            | perhaps change the        |
| The insolence of office and  | direction of our          |
| the spurns\                  | thinking.                 |
| That patient merit of the    |                           |
| unworthy takes,\             | We don’t control our      |
| When he himself might his    | dreams so what dreams may |
| quietus make\                | come in that sleep in     |
| With a bare bodkin? who      | which we have shuffled    |
| would fardels bear,\         | off all the fuss and      |
| To *grunt and sweat under a  | bother of life? He uses   |
| weary life*,                 | the term ‘[mortal coi     |
|                              | l](h%20t                  |
|                              | t%20ps:%20//n%20os%20weat |
|                              | s%20hakes%20peare%20.co%2 |
|                              | 0%20m%20/%20q%20u%20o%20t |
|                              | es/famous/mortal-coil/),’ |
|                              | which is an Elizabethan   |
|                              | word for a big fuss. With |
|                              | that thought, Hamlet      |
|                              | stops to reconsider. What |
|                              | will happen when we have  |
|                              | discarded all the hustle  |
|                              | and bustle of life?       |
+------------------------------+---------------------------+
| But that the *dread of       | *The problem with the     |
| something* after death,\     | proposition* is that the  |
| The *undiscover’d country*   | sleep of death is unknown |
| from whose bourn\            | and could be worse than   |
| No traveller returns,        | life.                     |
| *puzzles the will*\          |                           |
| And makes us rather bear     | Hamlet now lets his       |
| those *ills we have*\        | imagination wander on the |
| Than fly to others that we   | subject of the voyages of |
| know not of?                 | discovery and the         |
|                              | exploratory expeditions.  |
|                              | Dying is like crossing    |
|                              | the border between known  |
|                              | and unknown geography.    |
|                              | One is likely to be lost  |
|                              | in that unmapped place,   |
|                              | from which one would      |
|                              | never return. The         |
|                              | implication is that there |
|                              | may be unimagined horrors |
|                              | in that land.             |
+------------------------------+---------------------------+
| Thus conscience does make    | But there is more to it   |
| cowards of us all;\          | than that. It is not just |
| And thus the native hue of   | about killing himself but |
| resolution\                  | also about the mission he |
| Is sicklied o’er with the    | is on – to avenge his     |
| pale cast of thought,\       | father’s death by killing |
| And *enterprises of great    | his father’s murderer.    |
| pith and moment*\            | Throughout the action of  |
| With this regard their       | the play, he makes        |
| currents turn awry,\         | excuses for not killing   |
| And lose *the name of        | him and turns away when   |
| action*.                     | he has the chance.        |
|                              | ‘Conscience does make     |
| \                            | cowards of us all.’       |
|                              | Convention demands that   |
|                              | he kill Claudius but      |
|                              | murder is a sin and that  |
|                              | conflict is the core of   |
|                              | the play.                 |
|                              |                           |
|                              | At the end of the         |
|                              | soliloquy, he pulls       |
|                              | himself out of this       |
|                              | reflective mode by        |
|                              | deciding that too much    |
|                              | thinking about it is the  |
|                              | thing that will prevent   |
|                              | the action he has to rise |
|                              | to.                       |
+------------------------------+---------------------------+
| –Soft you now! The fair      | ~~Saraswati Namostute !   |
| Ophelia!\                    | Grant me Grace and        |
| Nymph, in thy orisons\       | Knowledge on How to       |
| Be all my sins remember’d.   | Proceed!~~                |
+------------------------------+---------------------------+
...
<u>[Shakespeare doesn't say, but Christopher Isherwood seems to think so, 
on Page 3](https://www.yumpu.com/en/document/read/35825580/vedanta-for-the-western-world-swami-vivekananda)</u>.

Aside: in Hindu mythology, who are the two who went into Hamlet's *"the
undiscover’d country"* and *did return*? How did they manage it?
...
Memory(STM)**](Lawrence-ADesignofExperimentsWorkshopasanIntroductiontoStatistics.pdf)</u> of Foundation Students at SMI as our vehicle for testing similar
Hypotheses.[^1]
...
(two-valued) parameters that are part of the test:
`Art vs Design`, `Windows vs Mac`, `Speaks Mother Tongue or Not`,
`Small Town vs Metro`, `Long vs Short List of Words`,
`Short vs Long Words` and `Long vs Short Exposure`.
...
Statistics - PDF**](Lawrence-ADesignofExperimentsWorkshopasanIntroductiontoStatistics.pdf)</u>).
...
tests using this Excel <u>[**spreadsheet**](STM.xlsx)</u>, which we can place on Google Drive for the whole class. (This is for the STM Hypothesis; we can adapt this spreadsheet for any other hypothesis test with categorical factors andscores.)
...
Experiment and make a comic out of it: <u>**Data Comic Generator from Gramener**
[(**Weblink**)](https://gramener.com/comicgen)</u>
...
2.  Tim C. Hesterberg (2015). *What Teachers Should Know About the 
Bootstrap: Resampling in the Undergraduate Statistics Curriculum*, 
The American Statistician, 69:4, 371-386, <u>DOI:10.1080/00031305.2015.1089789</u>. <u>[PDF here](hesterberg2015.pdf)</u>

3.  Mahashweta Devi, *The Why Why Girl*,
...
4.  Could this song indicate what our situation might be?
...
[^1]: Or we could use <u>[Guilford Alternative Uses Creative Test](<https://curtbonk.com/bobweb/r546/modules/creativity/creativity_tests/guilford_uses_task.html>)</u>
