...
NOTE: there is an *alliterative mnemonic* here: **S**amples have **S**tatistics; **P**opulations have **P**arameters. 
...
The `sample_mean`s (red dots), are themselves random because the samples are random, of course. It appears that they  are generally in the vicinity of the `pop_mean` (blue line). 
...
When we work with samples, we want to be able to speak with a certain degree of confidence about the **population mean**, based on the evaluation of **one** sample mean,not a whole large number of them.
Give that sample-means are normally distributed around the **population means**, we can say that $68%$ of *all possible sample-mean* lie within $ +/- 1 SE $ of the *population mean*; and further that $95%$ of of *all possible sample-mean* lie within $ +/- 1.5* SE $ of the *population mean*.
