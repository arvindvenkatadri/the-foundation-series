...
```{r,echo=FALSE}
download_file(path = "files/simulation.Rmd",
              output_name = "simulation",
              output_extension = ".ows",
              button_label = "Download simulation Workflow for Orange",
              button_type = "danger",
              has_icon = TRUE,
              icon = "fa fa-save",
...
download_file(path = "files/simulation.Rmd",
              ...
              button_label = "Download simulation Workflow for Radiant",
              button_type = "danger",
              has_icon = TRUE,
              icon = "fa fa-save",
              self_contained = FALSE)
...
In R, the easiest way to perform Simulation Tests is to use a package called `mosaic`. See [Project MOSAIC](http://www.mosaic-web.org/).

Please download the embedded file linked below and upload into RStudio.Cloud. 

```{r,echo=FALSE}
download_file(path = "files/simulation.Rmd",
              output_name = "simulation",
              output_extension = ".Rmd",
              button_label = "Download simulation code in R",
              button_type = "danger",
              has_icon = TRUE,
              icon = "fa fa-save",
              self_contained = FALSE)
...
2.  D. Salsburg. *The Lady Tasting Tea: How statistics revolutionized science in the twentieth century.* W.H. Freeman, New York, 2001
