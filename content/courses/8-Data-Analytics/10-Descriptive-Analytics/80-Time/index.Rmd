...
births_ts %>%
  summarise_by_time(.data = ., .date_var = date, .by = "month", mean = mean(births)) 
...
Hmm...a bit dense. Maybe some aggregation can help.....can we try to plot box plots over time (Candle-Stick Plots)?



```{r, echo=FALSE,message=FALSE}

births_ts %>% plot_time_series_boxplot(.date_var = date, 
                                       .value = births,
                                       .period = "year",
