...
A forest of such trees is called <u>[`r emoji("film")` ~~**the Wild Wood**~~](https://youtu.be/zE0uAfAuZ08)</u> **a Random Forest** ! 
...
<u><https://waternova.github.io/random-forest-viz/></u>
...
- <u>[`r emoji("music")` Do it **Again**](https://youtu.be/jmdiKePVUy8)</u> when presented with fresh data

Not bad, is it, as a metaphor for Random Forests? Can <u>[`r emoji("page_with_curl")`More is Different](Strogatz_et_al_2022_More_is_different.pdf)</u> be true here too?
...
We will download this data and use it with this Orange Workflow file. <u>[Random Forests Workflow File](random_forest.ows)</u>
